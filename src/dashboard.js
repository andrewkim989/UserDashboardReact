        ...
        return (
            <BrowserRouter>
                <div id = "home">
                    ...
                    <div id = "homemain">
                        <h1>Home</h1>
                        <h3>Welcome to User Dashboard home page! Click on 
...
class Login extends Component {
    ...
    registerSubmit(e) {
        ...
        if (nameexist.length > 0) {
            this.setState({rName: "", rPassword: "", rNameError: "Username already exists.", submit: false});
        }
        else if (passwordexist.length > 0) {
            this.setState({rName: "", rPassword: "", rPasswordError: "Password already exists.", submit: false});
        }
        else {
    ...
    render() {
        if (!valid) {
            ...
            for (var i = 0; i< users.length; i++) {
                userlist.push(<li key = {i}>{users[i].name}</li>);
            }
            return(
                <div id = "dashboard">
